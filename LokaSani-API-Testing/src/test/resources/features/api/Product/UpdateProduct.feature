...
Background:
  ...
  Scenario: Successfully update product with name only
  ...
  Scenario: Successfully update product with price only
  ...
  Scenario: Successfully update product with description only
 ...
 #######################  # CASE NEGATIVE #######################################
  @CaseNegativeUpdateProduct1
    Scenario: Can not update product with invalid ID
  ...
  Scenario: Can not update product with empty fields
