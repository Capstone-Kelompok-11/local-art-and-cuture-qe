...
#case positive
  Scenario: Successfully creates a new event
...
#case negative
  Scenario: Can not create an event without required fields
  ...
  Scenario: Can not create an event with invalid data format
